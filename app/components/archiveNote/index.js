...
class Note extends React.Component {
	...
	render() {
		return (
			<Link style={style.link} to={"/n/" + this.props.id}>
			<div onMouseEnter={this.hoverIn.bind(this)} onMouseLeave={this.hoverOut.bind(this)} style={this.state.hov ? style.hov : style.cont}>
